...
- 🛠️ **Multiplatform (JVM):** Compatible with any Kotlin or Java project (Java 17+).
...
```kotlin
dependencies {
    implementation("com.github.brunorce:currency-catalog:v1.0.1")
}
```
...
- 🛠️ **Multiplataforma (JVM):** Compatible con cualquier proyecto Kotlin o Java (Java 17+).
